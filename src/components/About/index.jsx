...
const About = () => {
  ...
  return (
    <section className="container m-auto md:py-10">
      <article
      ...
      >
        <div className="container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-14 md:mb-0 items-center text-center gap-2">
            <h1 className="title-font sm:text-5xl text-4xl font-bold text-gray-900">
              Red Inmobiliaria
              <br className="hidden lg:inline-block " />
            </h1>
            <h1 className="title-font sm:text-5xl text-4xl font-bold text-secondary">
              Valore
            </h1>
      ...
      >
        <div className="container mx-auto flex px-5 py-10 mt-10 md:flex-row flex-col-reverse items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center gap-2">
